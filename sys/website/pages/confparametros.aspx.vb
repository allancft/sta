...
#End Region
    ...
    Private Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            ...
            If Not (objConfiguracao.Salvar(CType(obrTxtDiasExclusao.Text.Trim, Integer), _
                                        Me.StrErro)) Then
        ...
        End Try
    End Sub
    Private Sub btnCriptografia_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCriptografia.Click
        Try
            objCriptografia = New aim.objCriptografia
            lblCriptografia.Text = objCriptografia.Criptografar(txtParam.Text)
